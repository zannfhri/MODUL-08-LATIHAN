...
<body>
    ...
    <?php $__env->startSection('content'); ?>
        <div class="container-sm my-5">
            <form action="<?php echo e(route('barangs.update', ['id' => $barangs->id])); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" type="text"
                                    ...
                                    value="<?php echo e($errors->any() ? old('kodeBarang') : $barangs->kode_barang); ?>"
...
unset($__errorArgs, $__bag); ?>" type="text"
                                    ...
                                    value="<?php echo e($errors->any() ? old('namaBarang') : $barangs->nama_barang); ?>"
...
unset($__errorArgs, $__bag); ?>" type="text"
                                    ...
                                    value="<?php echo e($errors->any() ? old('hargaBarang') : $barangs->harga_barang); ?>"
...
unset($__errorArgs, $__bag); ?>" type="text"
                                    ...
                                    value="<?php echo e($errors->any() ? old('deskripsiBarang') : $barangs->deskripsi_barang); ?>"
                                ...
                                <select name="satuan" id="satuan" class="form-select">
                                    ...
                                    <?php $__currentLoopData = $satuans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $satuan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($satuan->id); ?>"
                                            ...
                                            <?php echo e($satuan->code . ' - ' . $satuan->kode_satuan); ?></option>
